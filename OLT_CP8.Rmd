...
## This initial comparison uses the entire 10,000-row dataset to estimate the overall average impact of the standardized unemployment rate and the recession dummy on ln_units_sold.
